...
This guide will help you to contribute in different ways to My Python Project.
...
Go to the [pull request section](https://github.com/charlstown/my-python-project/pulls) in the repository and select the `New pull request` button.
